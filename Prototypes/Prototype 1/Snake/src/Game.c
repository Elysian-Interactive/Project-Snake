...
bool init()
{
	...
	window = SDL_CreateWindow("Snake Prototype 1",SDL_WINDOWPOS_UNDEFINED,SDL_WINDOWPOS_UNDEFINED,SCREEN_WIDTH,SCREEN_HEIGHT,SDL_WINDOW_SHOWN);
...
bool loadMedia()
{
	bool r = Snake_create((SCREEN_WIDTH - SNAKE_WIDTH) / 2, (SCREEN_HEIGHT - SNAKE_HEIGHT) / 2, SNAKE_UP);
